...
- Will need to fix some logic handling in some methods of MemoryAllocator and how it is implemented in the Scheduler class. This program is only designed to handle the test case provided in the canvas.
